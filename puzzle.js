...
,
  {name: 'Draw a wire',
   ...
   hint: ['<p>Go back to the help menu and select "Show introduction".  It has all the information you need.</p>',
          '<p>Look, if you\'re so bored that you\'re reading every hint, maybe you should use the main menu to skip ahead to a harder puzzle.  But don\'t come running to me when you don\'t know how to delete a wire.</p>'],
   truth: [{a: 1,   z: 1}],
   hide: ['truth', 'speed'],
   avail: [],
   cells: {
...
,
  {name: 'The truth table',
   ...
   hint: ['<p>Press play &play; to verify that your circuit is correct.</p>'],
   truth: [{a: 0,   z: 0},
           {a: 1,   z: 1}],
   hide: ['speed'],
   avail: [],
...
,
  {name: 'The NOT gate',
   ...
   outro: '<p>In many programming languages, the NOT gate is represented with a tilde.  E.g. Z = ~A.</p><p>A NOT gate is also commonly called an inverter.</p>',
   hint: ['<p>Press play &play; to verify that your circuit is correct.</p>'],
   truth: [{a: 0,   z: 1},
           {a: 1,   z: 0}],
   hide: ['speed'],
...
,
  {name: 'Simulation controls',
   ui: true,
   intro: '<p><b>Here are some new ways to control the simulation.</b></p><p>The small buttons next to the play button &play; tell the simulation to pause when the propagating values have reached a gate <svg style="vertical-align:middle" width="1.2857em" height="1em" viewBox="-4 -2 18 14" fill="none"><path d="M0,0v10h5a5,5,0,0,0,0,-10h-5z" stroke="#888" stroke-width="1.5"/><path d="M-2.5,2.5H0M-2.5,7.5H0M12.5,5H10" stroke="#888" stroke-width="1"/></svg>, when one truth table line has passed testing <svg style="vertical-align:middle" width="1em" height="1em" viewBox="-2 -2 14 14" fill="none"><path d="M1.25,5l2.5,5l5,-10" stroke="#888" stroke-width="1.5"/></svg>, or when all truth table rows have passed <svg style="vertical-align:middle" width="1em" height="1em" viewBox="-2 -2 14 14" fill="none"><path d="M0.25,2.5l1.25,2.5l2.5,-5M0.25,7.5l1.25,2.5l2.5,-5M5.5,2.5l1.25,2.5l2.5,-5M5.5,7.5l1.25,2.5l2.5,-5" stroke="#888" stroke-width="1"/></svg>.</p><p>The "speed" slider adjusts the speed of data flow from slow to fast.</p>',
...
,
  {name: 'The AND gate',
   ...
   outro: '<p>In many programming languages, the AND gate is represented with an ampersand.  E.g. Z = A &amp; B.</p><p><b>Make sure you clearly understand the relationship of the AND gate\'s output with its inputs</b>, as displayed in the truth table. You will soon learn five other simple logic gates, each of which perform a different logic function.</p>',
   truth: [{a:0, b:0,   z:0},
           {a:0, b:1,   z:0},
           {a:1, b:0,   z:0},
           {a:1, b:1,   z:1}],
...
,
  {name: 'The OR gate',
   ...
   outro: '<p>In many programming languages, the OR gate is represented with a vertical bar.  E.g. Z = A | B.</p><p>An OR gate is more precisely described with the legal term "and/or" because its output is 1 if its first input is 1 <i>and/or</i> its second input is 1.</p>',
   truth: [{a:0, b:0,   z:0},
           {a:0, b:1,   z:1},
           {a:1, b:0,   z:1},
           {a:1, b:1,   z:1}],
...
,
  {name: 'Build a mux',
   ...
   intro: '<p><b>Build a circuit that performs the same function as a mux</b>, but without using a mux gate.</p>',
   outro: '<p>Now you\'re building real circuits!</p>',
   hint: ['<p>Remember that if one input of an AND gate is 1, then the output of the AND gate equals its other input.</p>',
...
,
  {name: 'Hidden truths',
   ...
   hint: ['<p>You can write down the stimulus values and the expected value for each case to build your own truth table.</p>',
          '<p>You can slow down the simulation speed and press pause to get a good look at each case as it simulates.  Or you can use tell the simulator to automatically pause at the end of each case <svg style="vertical-align:middle" width="1em" height="1em" viewBox="-2 -2 14 14" fill="none"><path d="M1.25,5l2.5,5l5,-10" stroke="#888" stroke-width="1.5"/></svg>.</p>'],
   truth: [{a:0, b:0,   z:0},
           {a:0, b:1,   z:0},
           {a:1, b:0,   z:1},
           {a:1, b:1,   z:0}],
...
,
  {name: 'Build an XOR gate',
   ...
   hint: ['<p>After all those easy puzzles, this one should make you think a bit more.  Take your time to puzzle it out.</p>',
...
,
  {name: 'Detect odd',
   intro: '<p><b>Determine whether an odd number of stimulus pins have a 1 value.</b></p>',
   outro: '<p>Notice that it doesn\'t matter what order you put the XOR gates in. The result is always the same.</p>',
   hint: ['<p>Try starting with a circuit that works when&nbsp;C is 0, then add logic to handle the cases when C is 1.</p>',
          '<p>You may feel more comfortable with the AND and OR gates, but their power is limited if a NOT gate is not available.  Go ahead and use an XOR gate!</p>'],
   soln: '1s4-0,o,4,i0-1,o,4,i1-2,o,5,i1;175,xor,50+o,5,i0;350,xor,100+o,3,i',
   truth: [{a:0, b:0, c:0,   z:0},
           {a:1, b:0, c:0,   z:1},
           {a:0, b:1, c:0,   z:1},
           {a:1, b:1, c:0,   z:0},
