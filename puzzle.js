...
,
  {name: 'The NOT gate',
   ...
   outro: '<p><b>The NOT gate is typically represented in text with a tilde.  E.g. Z = ~A.</b>  (But be warned: most programming languages apply the tilde operation to general integers, so extra steps must be taken to limit the result to just 0 or 1.)</p><p><b>A NOT gate is also commonly called an inverter.</b></p>',
   hint: ['<p>Press play &play; to verify that your circuit is correct.</p>'],
   truth: [{a: 0,   z: 1},
           {a: 1,   z: 0}],
   hide: ['speed'],
...
,
  {name: 'Detect &gt;= 2',
   intro: '<p><b>Determine whether at least two stimulus pins have a value of 1.</b></p>',
...
,
  {name: 'Single-row mystery',
   ...
   hint: ['<p>You can\'t think logically about this puzzle unless you first convert the decimal values to binary.</p>',
          '<p>This puzzle tests four bits in one truth table row, but it is the equivalent of a puzzle that tests one bit in four truth table rows.</p>'],
   truth: [{a:12, b:10,   z:9}],
   cells: {
     a: {type: 'input',
         width: 4,
