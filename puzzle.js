...
,
  {name: 'Simulation controls',
   ui: true,
   intro: '<p><b>Here are some new ways to control the simulation.</b></p><p>The small buttons next to the play button &play; tell the simulation to pause when the propagating values have reached a <span class="nowrap">gate <svg style="vertical-align:middle" width="1.2857em" height="1em" viewBox="-4 -2 18 14" fill="none"><path d="M0,0v10h5a5,5,0,0,0,0,-10h-5z" stroke="#888" stroke-width="1.5"/><path d="M-2.5,2.5H0M-2.5,7.5H0M12.5,5H10" stroke="#888" stroke-width="1"/></svg>,</span> when one truth table line has passed <span class="nowrap">testing <svg style="vertical-align:middle" width="1em" height="1em" viewBox="-2 -2 14 14" fill="none"><path d="M1.25,5l2.5,5l5,-10" stroke="#888" stroke-width="1.5"/></svg>,</span> or when all truth table rows have <span class="nowrap">passed <svg style="vertical-align:middle" width="1em" height="1em" viewBox="-2 -2 14 14" fill="none"><path d="M0.25,2.5l1.25,2.5l2.5,-5M0.25,7.5l1.25,2.5l2.5,-5M5.5,2.5l1.25,2.5l2.5,-5M5.5,7.5l1.25,2.5l2.5,-5" stroke="#888" stroke-width="1"/></svg>.</span></p><p>The "speed" slider adjusts the speed of data flow from slow to fast.</p>',
