...
,
  {name: 'The NOR gate',
   intro: '<p><b>A NOR gate outputs an inverted value as compared to an OR gate.</b>  I.e. <span>Z = ~(A | B).</span></p><p>In this puzzle we introduce the concept of a "don\'t care" value. If A is 1, we know that the output of the NOR gate must always be 0, so we <i>don\'t care</i> what B is. Likewise, we <i>don\'t care</i> what A is when B is 1.</p>',
